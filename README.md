...
- [三、输入源](#三输入源)
  - [3.1 File源](#31-file源)
    - [（1）创建程序生成JSON格式的File源测试数据](#创建程序生成json格式的file源测试数据) 
    - [（2）创建程序对数据进行统计](#创建程序对数据进行统计) 
    - [（3）测试运行程序](#测试运行程序) 
    - [（4）处理警告](#处理警告) 
    - [（5）总结分析](#总结分析) 
  - [3.2 Kafka源](#32-kafka源)
    - [（1）启动Kafka](#启动kafka) 
    - [（2）编写生产者（Producer）程序](#编写生产者producer程序) 
    - [（3）安装Python3的Kafka支持](#安装python3的kafka支持) 
    - [（4）运行生产者程序](#运行生产者程序) 
    - [（5）编写并运行消费者（Consumer）程序](#编写并运行消费者consumer程序) 
      - [方式一](#方式一)
      - [方式二](#方式二)
    - [总结](#总结)
